...
1. Editing an employee's details
    ...
    2. Test case: `edit 1 n/Bob Choo p/22222222 e/bob@example.com r/Head of Office t/friend` (Valid entry)<br>
    ...
    3. Test case: `edit 1  n/Amy Choo p/22222222 e/amy@example.com r/Head of Office t/friend` (Preamble is a space)<br>
       Expected: After user enters "y" to a y/n confirmation prompt, The employee is edited. The success message is shown, along with the updated details.

    4. Test case: `edit 1 k n/Amy Choo p/22222222 e/amy@example.com r/Head of Office t/friend` (Preamble is not a space)<br>
    ...
    7. Test case: `edit 1 n/Amy Cho n/Bob Choo p/11111111 e/bob@meme.com r/Head of Operations t/friend` (Duplicate fields)<br>
    ...
    9. Test case: `edit n/James& p/11111111 e/bob@meme.com r/Head of Operations t/friend` (Invalid name)<br>
